...
class RandomConcatSampler(Sampler):
    ...
    def __init__(self,
        ...
        self.n_samples = sum([int(self.data_source.datasets[d_id].sample_ratio * self.n_samples_per_subset) for d_id in range(self.n_subset)]) * repeat
    ...
    def __iter__(self):
        ...
        for d_idx in range(self.n_subset):
            ...
            n_samples = int(self.data_source.datasets[d_idx].sample_ratio * self.n_samples_per_subset)
